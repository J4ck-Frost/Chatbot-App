...
const pool = new Pool({
  host: process.env.DB_HOST || '10.106.0.5',
  port: process.env.DB_PORT || 5432,
  database: process.env.DB_NAME || 'postgres-db',
  user: process.env.DB_USER || 'postgres',
  password: process.env.DB_PASSWORD || 'abcxyz',
  ssl: {
...
app.listen(port, () => {
  ...
  console.log('- DB_HOST:', process.env.DB_HOST || '10.106.0.5');
  console.log('- DB_PORT:', process.env.DB_PORT || '5432');
  console.log('- DB_NAME:', process.env.DB_NAME || 'postgres-db');
